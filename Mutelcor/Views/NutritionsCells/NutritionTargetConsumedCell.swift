...
extension NutritionTargetConsumedCell {
    ...
    fileprivate func setupUI(){
        ...
        self.nutrientsLabel.text = K_NUTRIENTS_TITLE.localized
        self.targetLabel.text = K_TARGET_TITLE.localized
        self.consumedLabel.text = K_CONSUMED_TITLE.localized
...
//    MARK:- Populate data
    func populateData(_ selectedDate : Date){
        ...
        if selectDate == currentDate {
            self.dateLabel.text = K_TODAY_TITLE.localized + ", " + selectDate
