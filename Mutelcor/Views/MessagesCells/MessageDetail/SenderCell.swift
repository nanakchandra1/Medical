...
extension SenderCell {
    ...
    func populateSenderData(_ messages : [PatientLatestMessages], indexPath : IndexPath){
    ...
    fileprivate func traiangleImage() -> UIImage {
        ...
        arrowPath.move(to: CGPoint(x: arrowWidth, y: 0))
        arrowPath.addLine(to: CGPoint(x: 0, y: arrowHeight / 2))
