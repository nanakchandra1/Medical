...
protocol OpenWebViewToViewAttachment {
...
//    ================
    enum CellCountOnCurrentActivity {
        ...
        case currentActivity, previousActivity
    ...
    var currentActivityPlanData = [CurrentActivityPlan]()
    var delegate : OpenWebViewToViewAttachment!
...
extension PastActivityPlanTableViewCell {
    ...
    fileprivate func setupUI(){
        ...
        self.doBtnOutlt.setTitle("DO'S", for: .normal)
        ...
        self.sepratorViewBtwnButton.backgroundColor = UIColor.dosBtnSepratorColor
...
//    ===========================================
    func populateData(_ previousActivityData : [PreviousActivityPlan]){
        ...
        if let startDate = previousActivityData[0].planStartDate, !startDate.isEmpty {
            ...
            startActivityDate = startDate.dateFString(DateFormat.utcTime.rawValue, DateFormat.ddMMMYYYY.rawValue)!
...
extension PastActivityPlanTableViewCell {
    ...
    @objc fileprivate func attachmentBtnTapped(_ sender : UIButton){
        ...
        if self.cellCountOnCurrentActivity == CellCountOnCurrentActivity.currentActivity{
            ...
            printlnDebug(self.attachmentUrl)
            printlnDebug(self.attachmentName)
