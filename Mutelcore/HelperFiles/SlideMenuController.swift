...
public struct SlideMenuOptions {
    ...
    public static var leftViewWidth: CGFloat = UIScreen.main.fixedCoordinateSpace.bounds.width - 100
    ...
    public static var shadowOffset: CGSize = CGSize(width: 3,height: 0)
