...
-(void)initView:(CGRect)frame{
    ...
    [self addGradient:self TopColor:UIColor.blackColor BottomColor:UIColor.whiteColor];
}
...
-(void)addGradient:(UIView*)view TopColor:(UIColor*)topColor BottomColor:(UIColor*)bottomColor {
    ...
    gradientlayer.frame = self.progressLayer.bounds;
    gradientlayer.startPoint = CGPointMake(0, 0);
    gradientlayer.endPoint = CGPointMake(0, 1);
    gradientlayer.colors = [NSArray arrayWithObjects:(id)[topColor CGColor], (id)[bottomColor CGColor], nil];
    
//    return [self.layer insertSublayer:gradientlayer above:self.progressLayer];
////    return [self.progressLayer addSublayer:gradientlayer];
}
